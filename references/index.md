...
- **[How a Non-Technical PM Built and Shipped an App with Claude Code in Six Weeks](https://claude.com/blog/how-a-non-technical-project-manager-built-and-shipped-a-stress-management-app-with-claude-code-in-six-weeks)** — Anthropic customer story (May 2026): zero-code PM Kostiantyn Vlasenko built Respiro with 15+ Claude Code subagents in 72 hours; "managing agents is like managing people"; app in App Store after six weeks with hundreds of users.
- **[你的AI应用被打穿只需要一句话｜12种注入攻击+五层防御体系](https://www.bilibili.com/video/BV1ahVr6gERA/)** — B站 UP主「费曼学AI」纯享版终章：AI 应用安全正确做法——12种注入攻击手法、5层防御体系、PII 双向脱敏、成本攻击防御。与技法 18 对照阅读（反面教材 vs 正确实践）。
